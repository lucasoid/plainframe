...
spl_autoload_register(function ($class) {
	...
	$classname =  array_pop($path_parts);
	$classname = str_replace("_", DIRECTORY_SEPARATOR, $classname);
	$dir = implode(DIRECTORY_SEPARATOR, $path_parts);
	if(!empty($dir)) {$dir = $dir.DIRECTORY_SEPARATOR;}
	$path = '..' . DIRECTORY_SEPARATOR . $dir.$classname.".php";
	if(file_exists($path)) {
		include_once($path);
	}
});
...
/**
 * Use Config.env.php to override these values for local development.
 * 
 */
